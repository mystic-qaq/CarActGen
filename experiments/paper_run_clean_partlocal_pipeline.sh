...
ROOT="${ROOT:-${REPO}/outputs/paper_experiments/fair_function_aware_partlocal}"
SPLIT_PATH="${SPLIT_PATH:-${CARACTGEN_SPLIT_PATH:-${REPO}/splits/object_sketch_dinov2_partlocal_seed123456798.json}}"
